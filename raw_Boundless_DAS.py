...
def create_llama(
    ...
    if config is None:
        config = LlamaConfig.from_pretrained("sharpbai/alpaca-7b-merged", cache_dir=cache_dir)
        ...
        tokenizer = LlamaTokenizer.from_pretrained("sharpbai/alpaca-7b-merged", cache_dir=cache_dir)
    else:
